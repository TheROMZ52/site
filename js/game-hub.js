...
(function () {
  ...
  const GAMES = [
    {
      ...
      single: {
        ...
        mobileHref: "/games/minecraft-mobile.html",
        action: "اجرای PC",
        mobileAction: "اجرای موبایل",
      },
      multi: {
        title: "Multiplayer SMP",
        status: "در حال آماده‌سازی",
        description:
          "یک SMP دائماً فعال با دنیای مشترک، ساخت‌وساز و پیشرفت تیمی.",
    ...
    },
    {
      ...
      single: {
        ...
        mobileHref: "/games/counter-strike-mobile.html",
        action: "اجرای PC",
        mobileAction: "اجرای موبایل",
      },
      multi: {
        ...
        status: "در حال آماده‌سازی",
        description:
          "مچ سریع کیل‌زون؛ هر بازیکن بعد از مرگ دوباره Spawn می‌شود و بازی تا پایان تایمر ادامه دارد.",
        bullets: [
          "Respawn بعد از مرگ",
          "Kill Feed",
          "امتیاز بر اساس Kill",
  ...
  function modeCard(game, mode, kind) {
    const bullets = (mode.bullets || [])
      .map((x) => `<span class="kz-hub-chip">${escapeHtml(x)}</span>`)
      .join("");
